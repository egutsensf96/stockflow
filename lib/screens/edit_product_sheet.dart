...
class _EditProductSheetState extends ConsumerState<EditProductSheet> {
  ...
  late TextEditingController _nameCtrl, _skuCtrl, _qtyCtrl;

  String? _categoryId;
  Uint8List? _imageBytes;
  bool _isImageModified =
      false; // Solo envía base64 si se cambia explícitamente
    ...
    try {
      await ref
          ...
          .updateProduct(
            ...
            imageBase64: _isImageModified && _imageBytes != null
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('✅ Producto actualizado con auditoría'),
              ...
              children: [
                ...
                ref
                    ...
                    .when(
                      ...
                      error: (_, __) => const _GlassDropdown(
                        value: null,
                        items: [],
                        onChanged: null,
                        hint: 'Error',
...
// 🧩 WIDGETS AUXILIARES (Reutilizados del add_product_sheet)
